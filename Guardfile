...
guard :minitest, spring: "bin/rails test", all_on_start: false do
  ...
  watch(%r{^lib/generators/((?<namespace>.+)/)?(?<generator>.+)/.+\.rb$})       { |m| "test/lib/generators/#{m[:namespace]}/#{m[:generator]}_generator_test.rb" }
  watch(%r{^lib/generators/((?<namespace>.+)/)?(?<generator>.+)/templates/.+$}) { |m| "test/lib/generators/#{m[:namespace]}/#{m[:generator]}_generator_test.rb" }
